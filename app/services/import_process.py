Warning: truncated output (original token count: 59332)
Total output lines: 5972
    ...
    def save_item_classifications(
        ...
        for requested in payload["items"]:
            ...
            row = (
                ...
                .filter(
                    NfeItemClassification.duimp_snapshot_id == snapshot.id,
                    NfeItemClassification.duimp_item_number…9332 tokens truncated…load.get("additional_info"),
        )
